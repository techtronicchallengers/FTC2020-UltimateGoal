...
@Autonomous(name = "RLHWP", group = "League")
public class RLHWP extends LinearOpMode
{
    ...
    @Override public void runOpMode()
    {
        ...
        */
        ...
        {
            turnToAngle(1, 0, 1);
            rampSpeedEncoderDrive(1, 20, 4);
            turnToAngle(1, 90, 5);
            rampSpeedEncoderDrive(1, -16, 4);
            ...
            rampSpeedEncoderDrive(1, 36, 7);
        }

        if(numRings == 1)
        {
            turnToAngle(1, 0, 1);
            rampSpeedEncoderDrive(1, 43, 4);
            turnToAngle(1, 90, 2);
            ...
            turnToAngle(1, 0, 3);
            rampSpeedEncoderDrive(1, -27, 5);
        }

        if(numRings == 4)
        {
            turnToAngle(1, 0, 1);
            rampSpeedEncoderDrive(1, 64, 7);
            turnToAngle(1, 90, 3);
            rampSpeedEncoderDrive(1, -18, 4);
            ...
            rampSpeedEncoderDrive(1, 42, 5);

            runtime.reset();
            while(runtime.seconds()<0.2)
            {
                ultimateBot.getChassisAssembly().moveLeft(1.0);
            }

            turnToAngle(1, 0, 3);
            rampSpeedEncoderDrive(1, -44, 5);
        }
    }
